...
// 该代码由 JsHD调试器 全自动生成 
//更多网页特效自动生成 请下载JsHD调试器
//https://www.coolapk.com/apk/com.Yyge.JsHD
//yinghua(number,size)
function yinghua(number,size){
	...
	function startSakura() {
	    ...
	    var canvas = document.createElement('canvas'),
	        cxt;
	    staticx = true;
	    canvas.height = pixwinHeight/size;
	    canvas.width = pixwinWidth/size;
	...
	console.log("本网页特效由 JsHD调试器 自动生成")
	console.log("更多网页特效自动生成请下载JsHD调试器")
	console.log("https://www.coolapk.com/apk/com.Yyge.JsHD")
}
