...
<head>
    ...
    <title>@yield('title') - 二级域名管理后台 - {{ config('app.name') }}</title>
...
<header class="navbar navbar-expand flex-md-row bd-navbar">
    <div class="navbar-nav-scroll">
        <ul class="navbar-nav bd-navbar-nav flex-row">
            ...
            <li class="nav-item">
                <a class="nav-link nav-logo-name d-none d-sm-block" href="/"><i class="fa fa-cloud"></i> 小周二级域名分发美化版
                    V{{ config('version') }} 小周最新美化版</a>
                <a class="nav-link nav-logo-name d-sm-none" href="/"><i class="fa fa-cloud"></i> 小周域名分发</a>
            </li>
        </ul>
    </div>
...
<div class="container-fluid">
    <div class="row flex-xl-nowrap">
        <div class="col-12 col-md-3 col-xl-2 bd-sidebar"><p></p>
            ...
            <div class="menu-item" style="background-color: #FFFFFF;">
                ...
                <ul class="collapse" id="menu-config">
                    ...
                    <li>
                        <a href="/admin/config/beautify">
                            <i class="fa fa-caret-right"></i> 美化配置
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="/admin/config/check">
                            <i class="fa fa-caret-right"></i> 域名配置/检测
                        </a>
                    </li>
                </ul>
            </div>
