    ...
    <div class="container" v-cloak="">
        <div class="row" v-if="act==='reg'">
            <div class="col-12 col-md-6 offset-md-3 mt-3 mt-sm-5">
                <div class="card mb-3">
                    <div class="card-header text-white bg-info "><center>注册账户</center></div>
                    <div class="card-body">
                        <form id="form-reg">
                            <div class="form-group row">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <div class="col-9">
                                    <input type="text" name="username" class="form-control" placeholder="设置用户名">
                                </div>
                            </div>
                            <div class="form-group row">
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <div class="col-9">
                                    ...
                                    <img title="点击刷新" src="/captcha"
                                         style="float: left;width: 208px; margin: 4px auto"
        ...
        <div class="row" v-else>
            <div class="col-12 col-md-6 offset-md-3 mt-3 mt-sm-5">
                <div class="card mb-3">
                    <div class="card-header text-white bg-info "><center>账户登录</center></div>
                    <div class="card-body">
                        <form id="form-login">
                            <div class="form-group row">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
